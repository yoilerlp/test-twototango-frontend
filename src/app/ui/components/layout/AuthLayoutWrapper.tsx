...
export default function AuthLayoutWrapper({ children }: PropsWithChildren) {
  return (
    <main className='flex h-screen'>
      <section className='hidden sm:flex w-1/2 bg-twototango text-white flex-col justify-center items-center'>
      ...
      <section className='grow h-full p-4 w-full sm:w-1/2 flex flex-col justify-center items-center'>
        {children}
      </section>
    </main>
  );
